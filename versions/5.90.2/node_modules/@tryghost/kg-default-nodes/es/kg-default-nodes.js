...
var linebreakSerializers = {
  import: {
    br: node => {
      ...
      if (isGoogleDocs) {
        if (node.previousElementSibling?.nodeName === 'P' && node.nextElementSibling?.nodeName === 'P' || [...headings, ...lists].includes(node.previousElementSibling?.nodeName) && node.nextElementSibling?.nodeName === 'P' || node.previousElementSibling?.nodeName === 'P' && [...headings, ...lists].includes(node.nextElementSibling?.nodeName)) {
          return {
            conversion: () => null,
            priority: 1
          };
